...
export async function createComment(req: AuthenticatedRequest, res: Response) {
  ...
  if (!existingArticle) throw new NotFoundError('article', articleId);
...
export async function createLike(req: AuthenticatedRequest, res: Response) {
  if (!req.user) throw new UnauthorizedError('Unauthorized');
...
export async function deleteLike(req: AuthenticatedRequest, res: Response) {
  if (!req.user) throw new UnauthorizedError('Unauthorized');
